<?php
// about us edited to meet the clients requirements
    ...
    <section class="about-us" id="aboutus">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                $no_of_skills = (
                !empty($zerif_aboutus_feature1_title) || !empty($zerif_aboutus_feature1_text) ? $no_of_skills += 1 : $no_of_skills = $no_of_skills);

                $no_of_skills = (
                !empty($zerif_aboutus_feature2_title) || !empty($zerif_aboutus_feature2_text) ? $no_of_skills += 1 : $no_of_skills = $no_of_skills);

                $no_of_skills = (
                !empty($zerif_aboutus_feature3_title) || !empty($zerif_aboutus_feature3_text) ? $no_of_skills += 1 : $no_of_skills = $no_of_skills);

                $no_of_skills = (
                !empty($zerif_aboutus_feature4_title) || !empty($zerif_aboutus_feature4_text) ? $no_of_skills += 1 : $no_of_skills = $no_of_skills);

                $col_of_skills_size = 12 / $no_of_skills;
                ...
                <!-- NEW Skills display -->
                <div class="clear"></div>
                <div class="col-md-12 skills_edited column" data-scrollreveal="enter right after 0s over 1s">
                    <?php if (!empty($zerif_aboutus_feature1_nr) || !empty($zerif_aboutus_feature1_title) || !empty($zerif_aboutus_feature1_text)): ?>
                        <div class="col-md-<?php echo $col_of_skills_size; ?>">
                            <div class="skill skill_1">


                                <?php

                                if (!empty($zerif_aboutus_feature1_nr)):
                                    echo ' <div  class="canvas-hack center-block" >';
                                    echo '<div class="skill-count center-block">';
                    ...
                    <!-- SKILL 2 -->
                    <?php if (!empty($zerif_aboutus_feature2_nr) || !empty($zerif_aboutus_feature2_title) || !empty($zerif_aboutus_feature2_text)): ?>

                        <div class="col-md-<?php echo $col_of_skills_size; ?>">

                            <div class="skill skill_2">
                    ...
                    <!--SKILL 3-->
                    <?php if (!empty($zerif_aboutus_feature3_nr) || !empty($zerif_aboutus_feature3_title) || !empty($zerif_aboutus_feature3_text)): ?>
                    ...
                    <?php endif; ?>
                    <!-- Skill 4 -->
                    <?php if (!empty($zerif_aboutus_feature4_nr) || !empty($zerif_aboutus_feature4_title) || !empty($zerif_aboutus_feature4_text)): ?>

                        <div class="col-md-<?php echo $col_of_skills_size; ?>">

                            <div class="skill skill_4">
            ...
            if (!empty($zerif_aboutus_biglefttitle)):
                ...
                <div class="col-lg-3 col-md-3">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/chart.png" alt="Gráfico"
                         class="img-responsive"/>
                </div>

                <?php

                echo '<div class="col-lg-9 col-md-9  zerif-rtl-big-title">';
            ...
            if (!empty($zerif_aboutus_text)):
                ...
                echo '<div class="col-lg-9 col-md-9 column zerif_about_us_center ' . $text_and_skills . '" data-scrollreveal="enter bottom after 0s over 1s">';
